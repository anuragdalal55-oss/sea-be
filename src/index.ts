...
import seaDeliveryPortRoutes from './routes/seaDeliveryPorts';
import seaHblRoutes from './routes/seaHbls';
import seaLoadingPortRoutes from './routes/seaLoadingPorts';
...
app.use('/api/reports', invoiceRoutes);
...
app.use('/api/sea-loading-ports', seaLoadingPortRoutes);
app.use('/api/sea-delivery-ports', seaDeliveryPortRoutes);
